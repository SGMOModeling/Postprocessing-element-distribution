...

{
  ...
  model_dir <- "C:/Users/ghuang/Documents/C2VSimCG2015/C2VSimCGv1.0 Runs/C2VSimCG_WY1974-2015_v1.0/Results/"
  ...
  for (layer_id in 1:4)
  {
...

    {
      ...
      if (max(abs(x1)) > 0.01) {
        ...
        mapshot(p2, url = paste0(getwd(), "//output//C2VSimCG_WY1974-2015_v1.0//groundwater//Map_", k, "_Layer", layer_id, ".htm"))

        #  rename map files for better read
        from_name <- paste0(getwd(), "//output//C2VSimCG_WY1974-2015_v1.0//groundwater//Map_", k, "_Layer", layer_id, ".htm")
        to_name <- paste0(getwd(), "/output//C2VSimCG_WY1974-2015_v1.0//groundwater/", model_run, "_'", trimws(column_index[k]), "_Layer", layer_id, ".htm")
        ...
        write.csv(y, file = paste0(getwd(), "//output//C2VSimCG_WY1974-2015_v1.0//groundwater//", model_run, "_'", trimws(column_index[k]), "_Layer", layer_id, ".csv"))
      }
    }
  }
}
write.csv(column_index, file = paste0(getwd(), "//output//C2VSimCG_WY1974-2015_v1.0//groundwater//", model_run, "_map_list", ".csv"))
