# General Comments --------------------------------------------------------
#
# Read root zone zonal budget HDF file directly for element level statistics and visualization
...
#  Loop over 83 water budget columns  
...
write.csv(column_index, file = paste0(getwd(), "/output/rootzone/", model_run, "_map_list",".csv"))
